...
#define STRING_CONFIG_H_AUTHOR "Robert Sand" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 160.54
  #define DEFAULT_bedKi 27.49
  #define DEFAULT_bedKd 625.03
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.60 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -6, -0.95 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + X_MIN_POS) + 10 // Extended max to allow the probe to reach more of the bed.

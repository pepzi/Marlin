...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  32, 208 }, { 203,  208 }, { 203, 38 }, { 32, 38 } }
  ...
  #define TRAMMING_POINT_NAME_4 "Front-Left"
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       88  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    84  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
